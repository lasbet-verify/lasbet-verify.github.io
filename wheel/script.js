...
function renderIdleState() {
  ...
  renderMeta([
    ...
    { label: t("bucketLabel"), value: "--" },
    { label: t("resultScaleLabel"), value: String(WheelVerifierCore.DEFAULT_RESULT_SCALE) },
    { label: t("gridCountLabel"), value: "--" },
    { label: t("probabilityLabel"), value: "--" },
    { label: t("oddsLabel"), value: "--" },
    { label: t("rtpLabel"), value: "--" },
    { label: t("serverResultLabel"), value: "--" },
    { label: t("betAreaLabel"), value: "--" },
    { label: t("resultCompareLabel"), value: "--" },
    { label: t("theoreticalPayoutLabel"), value: "--" },
    { label: t("actualPayoutLabel"), value: "--" },
    { label: t("maxPayoutCapLabel"), value: "--" },
  ]);
  renderFormula([
...
function renderResult(result) {
  ...
  renderMeta([
    ...
    { label: t("bucketLabel"), value: String(result.bucket) },
    { label: t("resultScaleLabel"), value: String(result.resultScale) },
    { label: t("gridCountLabel"), value: String(result.gridCount) },
    { label: t("probabilityLabel"), value: result.probabilityText },
    { label: t("oddsLabel"), value: result.oddsText },
    { label: t("rtpLabel"), value: result.rtpText },
    { label: t("serverResultLabel"), value: getColorDisplay(result.resultColor, result.resultColorRaw) },
    { label: t("betAreaLabel"), value: optionalText(result.betArea) },
    { label: t("resultCompareLabel"), value: result.resultCompareValue },
    { label: t("theoreticalPayoutLabel"), value: optionalText(result.theoreticalPayoutAmount) },
    { label: t("actualPayoutLabel"), value: optionalText(result.actualPayoutAmount) },
    { label: t("maxPayoutCapLabel"), value: optionalText(result.maxPayoutCapAmount) },
    { label: t("maxPayoutReasonLabel"), value: optionalText(result.maxPayoutHitReason) },
  ]);
  renderFormula([
    "commitment = SHA-256(server_seed)",
    "H = HMAC_SHA256(server_seed, String(nonce))",
